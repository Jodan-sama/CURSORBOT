...
export const B5_CONFIG = {
  ...
  minPositionUsd: 5,
  /** Skip 5-min when past this many seconds into window. Default 250 = first 250s of 5m window. */
  max5minSecondsIntoWindow: Number(process.env.B5_MAX_5MIN_SECONDS_INTO_WINDOW) ?? 250,
